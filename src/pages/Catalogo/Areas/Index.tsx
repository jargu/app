...
const rowData = [
    {
        id: 1,
        firstName: 'Caroline',
        lastName: 'Lunes, Martes, Miércoles',
    ...
    },
    {
        id: 3,
        firstName: 'Tillman',
        lastName: 'Viernes, Sábado, Domingo',
        email: 'Atleta 1, Atleta 2, Atleta 3, Atleta 4',
        dob: '2016-09-05',
        address: {
    ...
    },
    {
        id: 4,
        firstName: 'Daisy',
        lastName: 'Lunes, Martes, Miércoles, Jueves, Viernes, Sábado, Domingo',
        email: 'Atleta 1, Atleta 2, Atleta 3, Atleta 4',
        dob: '1987-03-23',
        address: {
...
const UserIndex = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Ver Áreas de entrenamiento'));
    });
    ...
    const actionShow = () => {
        navigate('/catalogo/areas/editar');
    };
    const actionEdit = () => {
        navigate('/catalogo/areas/editar');
    };
            ...
            <div className='panel mt-6'>
                <div>
                    <div className="flex items-center justify-end sm:justify-between mb-5 text-danger">
                        <div className='flex'>
                            <IconoMenuMarcas /><h5 className="font-semibold text-lg dark:text-white-light ml-2"> Áreas de entrenamiento</h5>
                        </div>
                        <div>
                            <Link to="/catalogo/areas/agregar" className="btn btn-success ml-3 flex">
                                <svg width="20" height="20" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round" className="w-4 h-4"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>&nbsp;{'Agregar área'}
                            </Link>
                        </div>
                    </div>
                </div>
                <div className="flex md:items-center md:flex-row flex-col mb-5 gap-5">
                    <h5 className="font-semibold text-lg dark:text-white-light">Tabla de entrenamientos</h5>
                ...
                <div className="datatables">
                    <DataTable
                        ...
                        columns={[
                            ...
                            { accessor: 'firstName', title: 'Nombre del área', sortable: true },
                            { accessor: 'lastName', title: 'Días', sortable: true },
                            {
                                accessor: 'action',
                                title: 'Acciones',
