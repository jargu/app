...
const AddUser = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Souvenirs Crear'));
    });
                        ...
                        <form className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input id="name" type="text" placeholder="Nombre completo del Souvenirs" defaultValue="" className="form-input" />
                                </div>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <textarea id="ctnTextarea" rows={3} className="form-textarea" placeholder="Especificaciones"></textarea>
                                </div>
                            </div>
