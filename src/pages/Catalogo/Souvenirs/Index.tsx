...
const rowData = [
    {
        ...
        firstName: 'Caroline',
        lastName: 'Jensen',
        email: 'carolinejensen@pro-tic.mx',
        dob: '2004-05-28',
        address: {
    ...
    },
    {
        ...
        firstName: 'Tillman',
        lastName: 'Forbes',
        email: 'tillmanforbes@pro-tic.mx',
        dob: '2016-09-05',
        address: {
    ...
    },
    {
        ...
        firstName: 'Buckley',
        lastName: 'Townsend',
        email: 'buckleytownsend@pro-tic.mx',
        dob: '2011-05-29',
        address: {
    ...
    },
    {
        ...
        firstName: 'Latoya',
        lastName: 'Bradshaw',
        email: 'latoyabradshaw@pro-tic.mx',
        dob: '2010-11-23',
        address: {
    ...
    },
    {
        ...
        firstName: 'Marva',
        lastName: 'Sandoval',
        email: 'marvasandoval@pro-tic.mx',
        dob: '2010-11-02',
        address: {
    ...
    },
    {
        ...
        firstName: 'Decker',
        lastName: 'Russell',
        email: 'deckerrussell@pro-tic.mx',
        dob: '1994-04-21',
        address: {
    ...
    },
    {
        ...
        firstName: 'Sellers',
        lastName: 'Walters',
        email: 'sellerswalters@pro-tic.mx',
        dob: '1975-11-12',
        address: {
    ...
    },
    {
        ...
        firstName: 'Levine',
        lastName: 'Rodriquez',
        email: 'levinerodriquez@pro-tic.mx',
        dob: '1973-02-08',
        address: {
    ...
    },
    {
        ...
        firstName: 'Little',
        lastName: 'Hatfield',
        email: 'littlehatfield@pro-tic.mx',
        dob: '2012-01-03',
        address: {
    ...
    },
    {
        ...
        firstName: 'Ebony',
        lastName: 'Livingston',
        email: 'ebonylivingston@pro-tic.mx',
        dob: '1994-10-18',
        address: {
    ...
    },
    {
        ...
        firstName: 'Carmella',
        lastName: 'Mccarty',
        email: 'carmellamccarty@pro-tic.mx',
        dob: '1980-03-06',
        address: {
...
const UserIndex = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Ver Souvenirs'));
    });
    const isRtl = useSelector((state: IRootState) => state.themeConfig.rtlClass) === 'rtl' ? true : false;
    const [page, setPage] = useState(1);
    const PAGE_SIZES = [10, 20, 30, 50, 100];
    const [pageSize, setPageSize] = useState(PAGE_SIZES[0]);
    const [initialRecords, setInitialRecords] = useState(sortBy(rowData2, 'id'));
        ...
        setInitialRecords(() => {
            return rowData2.filter((item) => {
                return (
                    ...
                    item.especificaciones.toLowerCase().includes(search.toLowerCase()) ||
                    item.precio.toLowerCase().includes(search.toLowerCase()) ||
                    item.imagen.toLowerCase().includes(search.toLowerCase())
                );
            });
        });
    ...
    const actionShow = () => {
        navigate('/catalogo/souvenirs/editar');
    };
    const actionEdit = () => {
        navigate('/catalogo/souvenirs/editar');
    };
            ...
            <div className='panel mt-6'>
                <div>
                    <div className="flex items-center justify-end sm:justify-between mb-5 text-danger">
                        <div className='flex'>
                            <IconoMenuMarcas /><h5 className="font-semibold text-lg dark:text-white-light ml-2"> Souvenirs</h5>
                        </div>
                        <div>
                            <Link to="/catalogo/souvenirs/agregar" className="btn btn-success ml-3 flex">
                                <svg width="20" height="20" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round" className="w-4 h-4"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>&nbsp;{'Agregar souvenirs'}
                            </Link>
                        </div>
                    </div>
                </div>
                <div className="flex md:items-center md:flex-row flex-col mb-5 gap-5">
                    <h5 className="font-semibold text-lg dark:text-white-light">Tabla de Souvenirs</h5>
                ...
                <div className="datatables">
                    <DataTable
                        ...
                        columns={[
                            ...
                            { accessor: 'especificaciones', title: 'Especificaciones', sortable: true,
                                render: (record) => (
                            ...
                            { accessor: 'precio', title: 'Precio', sortable: true },
                            { accessor: 'imagen', title: 'Galeria', sortable: true },
                            {
                                accessor: 'action',
                                title: 'Acciones',
