...
const UserIndex = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Ver Atletas'));
    });
    ...
    const actionShow = () => {
        navigate('/catalogo/atletas/editar');
    };
    const actionEdit = () => {
        navigate('/catalogo/atletas/editar');
    };
            ...
            <div className='panel mt-6'>
                <div>
                    <div className="flex items-center justify-end sm:justify-between mb-5 text-danger">
                        <div className='flex'>
                            <IconoMenuMarcas /><h5 className="font-semibold text-lg dark:text-white-light ml-2"> Atletas</h5>
                        </div>
                        <div>
                            <Link to="/catalogo/atletas/agregar" className="btn btn-success ml-3 flex">
                                <svg width="20" height="20" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round" className="w-4 h-4"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>&nbsp;{'Agregar atleta'}
                            </Link>
                        </div>
                    </div>
                </div>
                <div className="flex md:items-center md:flex-row flex-col mb-5 gap-5">
                    <h5 className="font-semibold text-lg dark:text-white-light">Tabla de Atletas</h5>
                ...
                <div className="datatables">
                    <DataTable
                        ...
                        columns={[
                            ...
                            { accessor: 'address.street', title: 'Domicilio', sortable: true },
                            { accessor: 'company', title: 'Subcategoria', sortable: true },
                            { accessor: 'address.zipcode', title: 'Grupo', sortable: true },
                            {
                                accessor: 'action',
                                title: 'Acciones',
