...
const AddUser = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Instructores Crear'));
    });
                        ...
                        <form className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                <div>
                                    ...
                                    <input id="name" type="text" placeholder="Ingresa el nombre del instructor" defaultValue="" className="form-input" />
                                </div>
                                <div>
                                ...
                                {items.map((item: any) => {
                                    return (
                                        <div className='grid grid-cols-1 md:grid-cols-4 gap-4 mt-4' key={item.id}>
                                            ...
                                            <div>
                                                <Select placeholder="Seleccione el grupo" options={options4} isSearchable={false}/>
                                            </div>
