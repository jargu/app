...
const Store = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Tienda pedidos'));
    });
    ...
    const saveUser = () => {
        if (!params.name) {
            showMessage('Nombre es requerido.', 'error');
            return true;
        }
        if (!params.email) {
            showMessage('Email es requerido.', 'error');
            return true;
        }
        if (!params.phone) {
            showMessage('Teléfono es requerido.', 'error');
            return true;
        }
        if (!params.role) {
            showMessage('El producto es requerido.', 'error');
            return true;
        }
        if (!params.price) {
            showMessage('El precio es requerido.', 'error');
            return true;
        }
        ...
        showMessage('El pedido ha sido guardado exitosamente.');
    ...
    const deleteUser = (user: any = null) => {
        ...
        showMessage('El pedido ha sido eliminado exitosamente.');
    };
    ...
    return (
        <div>
            <div className="flex items-center justify-between flex-wrap gap-4">
                <h2 className="text-xl">Pedidos</h2>
                <div className="flex sm:flex-row flex-col sm:items-center sm:gap-3 gap-4 w-full sm:w-auto">
                    <div className="flex gap-3">
                        <div>
                            <button type="button" className="btn btn-primary" onClick={() => editUser()}>
                                <IconShoppingCart className="ltr:mr-2 rtl:ml-2" />
                                Agregar Pedido
                            </button>
                        </div>
                        <div>
                    ...
                    <div className="relative">
                        <input type="text" placeholder="Buscar pedido" className="form-input py-2 ltr:pr-11 rtl:pl-11 peer" value={search} onChange={(e) => setSearch(e.target.value)} />
                                ...
                                <div className="bg-white dark:bg-[#1c232f] rounded-md overflow-hidden text-center shadow relative">
                                    ...
                                    <div className="px-6 pb-24 -mt-10 relative">
                                        ...
                                        <div className="mt-6 grid grid-cols-1 gap-4 ltr:text-left rtl:text-right">
                                            ...
                                            <div className="flex items-center">
                                                <div className="flex-none ltr:mr-2 rtl:ml-2">Teléfono :</div>
                                                <div className="text-white-dark">{contact.phone}</div>
                                            </div>
                                            <div className="flex items-center">
                                                <div className="flex-none ltr:mr-2 rtl:ml-2">Dirección :</div>
                                    ...
                                    <div className="p-5">
                                        <form>
                                            <div className="mb-5">
                                                ...
                                                <input id="name" type="text" placeholder="Ingresa el Nombre" className="form-input" value={params.name} onChange={(e) => changeValue(e)} />
                                            </div>
                                            <div className="mb-5">
                                                <label htmlFor="email">Email</label>
                                                <input id="email" type="email" placeholder="Ingresa el Email" className="form-input" value={params.email} onChange={(e) => changeValue(e)} />
                                            </div>
                                            <div className="mb-5">
                                                <label htmlFor="number">Número de teléfono</label>
                                                <input id="phone" type="text" placeholder="Ingresa el Número de teléfono" className="form-input" value={params.phone} onChange={(e) => changeValue(e)} />
                                            </div>
                                            <div className="mb-5">
                                                <label htmlFor="occupation">Producto</label>
                                                <input id="role" type="text" placeholder="Ingresa el Producto" className="form-input" value={params.role} onChange={(e) => changeValue(e)} />
                                            </div>
                                            <div className="mb-5">
                                                <label htmlFor="occupation">Precio</label>
                                                <input id="price" type="text" placeholder="Ingresa el Precio" className="form-input" value={params.price} onChange={(e) => changeValue(e)} />
                                            </div>
                                            <div className="mb-5">
                                                ...
                                                <textarea
                                                    ...
                                                    className="form-textarea resize-none min-h-[80px]"
