                    ...
                    <div className="flex items-center justify-end sm:justify-between mb-5 text-danger">
                        ...
                        <div>
                            <Link to="#" className="btn btn-success ml-3 flex">
                                <svg width="20" height="20" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round" className="w-4 h-4"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>&nbsp;{'Agregar entrenamiento'}
                            </Link>
                        </div>
                    </div>
                </div>
                ...
                <div className="datatables">
                    <DataTable
                        ...
                        columns={[
                            ...
                            { accessor: 'age', title: 'Edad', sortable: true },
                            {
                                accessor: 'dob',
                                title: 'Creado el',
                                sortable: true,
