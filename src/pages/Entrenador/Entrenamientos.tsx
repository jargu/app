    ...
    return (
        <div>
            ...
            <div className="panel mt-6">
                <div>
                    <div className="flex items-center justify-start sm:justify-between mb-5 text-danger">
                        <div className='flex'>
                            <IconoMenuMarcas /><h5 className="font-semibold text-lg dark:text-white-light ml-2"> Entrenamientos</h5>
                        </div>
                    </div>
                    <div className="flex items-center justify-end sm:justify-between mb-5 text-danger">
                        <div>
                            <Link to="/entrenador/entrenamientos/agregar" className="btn btn-success ml-3 flex">
                ...
                <div className="datatables">
                    <DataTable
                        ...
                        columns={[
                            ...
                            { accessor: 'lastName', title: 'Área', sortable: true },
                            { accessor: 'age', title: 'Asistencia', sortable: true, render: (row) => `${row.age - 8} / ${row.age}`, },
                            {
                                accessor: 'action',
                                title: 'Acción',
                        ...
                        minHeight={200}
                        onRowClick={(row) => {
                            window.location.href = `/entrenador/entrenamientos/editar`;
                        }}
