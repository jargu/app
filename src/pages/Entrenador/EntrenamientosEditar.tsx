...
const AddUser = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Editar Entrenamientos'));
    });
    ...
    const [date2, setDate2] = useState<any>('2024-11-15 12:00');
                        ...
                        <form className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
                                <div>
                                    ...
                                    <Select placeholder="Selecciona el área" options={optionsAtletas} defaultValue={optionsAtletas[0]} isSearchable={false} />
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <Select placeholder="Selecciona el grupo" options={options4} defaultValue={options4[2]} isSearchable={false} />
                                </div>
                            </div>
