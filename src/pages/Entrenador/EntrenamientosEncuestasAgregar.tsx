                        ...
                        <form className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                <div>
                                    ...
                                    <input id="name" type="text" placeholder="Ingresa el tema general" className="form-input" />
                                </div>
                                <div>
                                    <label htmlFor="name">Pregunta</label>
                                    <input id="name" type="text" placeholder="Ingresa el nombre de la pregunta" className="form-input" />
                                </div>
                            </div>
                            <div>
                                <label htmlFor="name">Agregar opciones</label>
                            </div>
                            {items.map((item: any) => {
                                return (
