...
const AddUser = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Grupos Crear'));
    });
                        ...
                        <form className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                <div>
                                    ...
                                    <input id="name" type="text" placeholder="Ingresa el nombre del grupo" defaultValue="" className="form-input" />
                                </div>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                <div>
                            ...
                            <div>
                                <label htmlFor="name">Agregar Atletas</label>
                            </div>
                            {items.map((item: any) => {
                                return (
