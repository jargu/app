...
const contactList = [
        ...
        messages: [
            {
                fromUserId: 0,
                toUserId: 1,
                text: 'Hola, estoy de vuelta de vacaciones',
            },
            {
                fromUserId: 0,
                toUserId: 1,
    ...
    },
    {
        ...
        messages: [
            ...
            },
            {
                fromUserId: 0,
                toUserId: 2,
                text: 'Tengo una pregunta sobre el proyecto.',
            },
        ],
        active: false,
    },
    {
        ...
        path: 'profile-2.jpeg',
        time: '1:44 PM',
        preview: 'Olvidé cómo se sentía antes',
        messages: [
            {
                fromUserId: 0,
                toUserId: 3,
    ...
    },
    {
        ...
        path: 'profile-3.jpeg',
        time: '2:06 PM',
        preview: 'Pero probablemente necesitemos una nueva alfombra.',
        messages: [
            {
                fromUserId: 0,
                toUserId: 4,
                text: 'Hola, recoge tu cheque',
            },
            {
                fromUserId: 4,
                toUserId: 0,
                text: 'Ok, llegaré en 10 minutos',
            },
        ],
        active: true,
    },
    ...
    },
    {
        ...
        path: 'profile-5.jpeg',
        time: '2:00 PM',
        preview: '¿Qué pasa por tercera vez?',
        messages: [
            {
                fromUserId: 0,
                toUserId: 6,
            ...
            },
            {
                fromUserId: 0,
                toUserId: 6,
                text: 'Archivos subidos al servidor.',
            },
        ],
        active: false,
    },
    ...
    },
    {
        ...
        path: 'profile-7.jpeg',
        time: '12:09 PM',
        preview: '¿Quieres que te entregue el reporte mañana?',
        messages: [],
        active: true,
    },
    {
    ...
    return (
        <div>
            <div className={`flex gap-5 relative sm:h-[calc(100vh_-_150px)] h-full sm:min-h-0 ${isShowChatMenu ? 'min-h-[999px]' : ''}`}>
                <div className={`panel p-4 flex-none max-w-full w-full absolute xl:relative z-10 space-y-4 xl:h-full hidden xl:block overflow-hidden ${isShowChatMenu ? '!block' : ''}`}>
                    ...
                    <div className="relative">
                        <input type="text" className="form-input peer ltr:pr-9 rtl:pl-9" placeholder="Buscar..." value={searchUser} onChange={(e) => setSearchUser(e.target.value)} />
                    ...
                    {!isShowUserChat && (
                        <div className="flex items-center justify-center h-full relative p-4">
                            ...
                            <div className="py-8 flex items-center justify-center flex-col">
                                ...
                                <p className="flex justify-center bg-white-dark/20 p-2 font-semibold rounded-md max-w-[250px] mx-auto">
                                    <button className='flex' type="button" onClick={() => setIsShowChatMenu(!isShowChatMenu)}>
                                    <IconMessage className="ltr:mr-2 rtl:ml-2" />
                                    Click para iniciar un chat
                                    </button>
                                </p>
                            </div>
                        </div>
                            ...
                            <div className="flex justify-between items-center p-4">
                                <div className="flex items-center space-x-2 rtl:space-x-reverse">
                                    ...
                                    <div className="mx-3">
                                        ...
                                        <p className="text-white-dark text-xs">{selectedUser.active ? 'Activo ahora' : 'Visto última vez ' + selectedUser.time}</p>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-5 p-4 sm:pb-0 pb-[68px] sm:min-h-[300px] min-h-[400px]">
                                    <div className="block m-6 mt-0">
                                        <h4 className="text-xs text-center border-b border-[#f4f4f4] dark:border-gray-800 relative">
                                            <span className="relative top-2 px-3 bg-white dark:bg-black">{'Hoy, ' + selectedUser.time}</span>
                                        </h4>
                                    </div>
                                                        ...
                                                        <div className={`flex items-start gap-3 ${selectedUser.userId === message.fromUserId ? 'justify-end' : ''}`}>
                                                            ...
                                                            <div className="space-y-2">
                                                                ...
                                                                <div className={`text-xs text-white-dark ${selectedUser.userId === message.fromUserId ? 'ltr:text-right rtl:text-left' : ''}`}>
                                                                    {message.time ? message.time : 'Hace 5h'}
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
