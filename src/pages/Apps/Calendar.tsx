...
const Calendar = () => {
    ...
    const defaultParams = { id: 0, title: '', start: '', end: '', description: '', type: 'primary' };
            ...
            <div className="panel mb-5">
                <div className="mb-4 flex items-center sm:flex-row flex-col sm:justify-between justify-center">
                    <div className="sm:mb-0 mb-4">
                        <div className="text-lg font-semibold ltr:sm:text-left rtl:sm:text-right text-center">Calendario</div>
