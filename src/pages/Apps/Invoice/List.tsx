            ...
            <div className="invoice-table">
                ...
                <div className="datatables pagination-padding">
                    <DataTable
                            ...
                            },
                            {
                                ...
                                render: ({ id }) => (
                                    <div className="flex gap-4 items-center w-max mx-auto">
                                        <NavLink to="/apps/factura/edit" className="flex hover:text-info">
                                            <IconEdit className="w-4.5 h-4.5" />
                                        </NavLink>
                                        <NavLink to="/apps/factura/preview" className="flex hover:text-primary">
                                            <IconEye />
                                        </NavLink>
                        ...
                        paginationText={({ from, to, totalRecords }) => `Mostrando  ${from} de ${to} a ${totalRecords} entradas`}
                    />
                </div>
            </div>
        </div>
