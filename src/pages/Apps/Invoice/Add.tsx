...
const Add = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Agregar factura'));
    });
                ...
                <div className="flex justify-between flex-wrap px-4">
                    ...
                    <div className="lg:w-1/2 w-full lg:max-w-fit">
                        ...
                        <div className="flex items-center mt-4">
                            ...
                            <input id="invoiceLabel" type="text" name="inv-label" className="form-input lg:w-[250px] w-2/3" placeholder="Ingresa el asunto de factura" />
                        </div>
                        <div className="flex items-center mt-4">
                            <label htmlFor="startDate" className="flex-1 ltr:mr-2 rtl:ml-2 mb-0">
                                Fecha de factura
                            </label>
                            <input id="startDate" type="date" name="inv-date" className="form-input lg:w-[250px] w-2/3" lang="es"/>
                        </div>
                        <div className="flex items-center mt-4">
                            <label htmlFor="dueDate" className="flex-1 ltr:mr-2 rtl:ml-2 mb-0">
                                Fecha de vencimiento
                            </label>
                            <input id="dueDate" type="date" name="due-date" className="form-input lg:w-[250px] w-2/3" lang="es"/>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex justify-between lg:flex-row flex-col">
                        <div className="lg:w-1/2 w-full ltr:lg:mr-6 rtl:lg:ml-6 mb-6">
                            ...
                            <div className="mt-4 flex items-center">
                                ...
                                <input id="reciever-name" type="text" name="reciever-name" className="form-input flex-1" placeholder="Ingresa el nombre completo" />
                            </div>
                            <div className="mt-4 flex items-center">
                                <label htmlFor="reciever-email" className="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">
                                    Correo electrónico
                                </label>
                                <input id="reciever-email" type="email" name="reciever-email" className="form-input flex-1" placeholder="Ingresa Correo electrónico" />
                            </div>
                            <div className="mt-4 flex items-center">
                                <label htmlFor="reciever-address" className="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">
                                    Dirección
                                </label>
                                <input id="reciever-address" type="text" name="reciever-address" className="form-input flex-1" placeholder="Ingresa Dirección" />
                            </div>
                            <div className="mt-4 flex items-center">
                                <label htmlFor="reciever-number" className="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">
                                    Número de teléfono
                                </label>
                                <input id="reciever-number" type="text" name="reciever-number" className="form-input flex-1" placeholder="Ingresa Número de teléfono" />
                            </div>
                        </div>
                        <div className="lg:w-1/2 w-full">
                            ...
                            <div className="flex items-center mt-4">
                                ...
                                <input id="acno" type="text" name="acno" className="form-input flex-1" placeholder="Ingresa Número de cuenta" />
                            </div>
                            <div className="flex items-center mt-4">
                                <label htmlFor="bank-name" className="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">
                                    Nombre del banco
                                </label>
                                <input id="bank-name" type="text" name="bank-name" className="form-input flex-1" placeholder="Ingresa Nombre del banco" />
                            </div>
                            <div className="flex items-center mt-4">
                                <label htmlFor="swift-code" className="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">
                                    Número SWIFT
                                </label>
                                <input id="swift-code" type="text" name="swift-code" className="form-input flex-1" placeholder="Ingresa Número SWIFT" />
                            </div>
                            <div className="flex items-center mt-4">
                                <label htmlFor="iban-code" className="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">
                                    Número IBAN
                                </label>
                                <input id="iban-code" type="text" name="iban-code" className="form-input flex-1" placeholder="Ingresa Número IBAN" />
                            </div>
                            <div className="flex items-center mt-4">
                    ...
                    <div className="mt-4">
                        <div className="grid sm:grid-cols-2 grid-cols-1 gap-4">
                            <div>
                                ...
                                <input id="tax" type="number" name="tax" className="form-input" defaultValue={0} placeholder="Impuesto" />
                            </div>
                            <div>
                                <label htmlFor="discount">Descuento(%) </label>
                                <input id="discount" type="number" name="discount" className="form-input" defaultValue={0} placeholder="Descuento" />
                            </div>
                        </div>
                    </div>
                    <div className="mt-4">
                        <div>
                            <label htmlFor="shipping-charge">Cargo de envío($) </label>
                            <input id="shipping-charge" type="number" name="shipping-charge" className="form-input" defaultValue={0} placeholder="Cargo de envío" />
                        </div>
                    </div>
                    <div className="mt-4">
