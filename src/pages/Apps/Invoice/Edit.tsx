...
const Edit = () => {
    ...
    const currencyList = ['EURO - Unión Europea', 'USD - US Dollar', 'GBP - British Pound', 'IDR - Indonesian Rupiah', 'INR - Indian Rupee', 'BRL - Brazilian Real', 'EUR - Germany (Euro)', 'TRY - Turkish Lira'];
    ...
    const [items, setItems] = useState<any>([
        ...
        },
        {
            ...
            description: 'Set de tres piezas',
            quantity: 1,
            amount: 25,
            isTax: false,
        },
    ]);
    const [selectedCurrency, setSelectedCurrency] = useState('EURO - Unión Europea');
    const [params, setParams] = useState<any>({
        title: 'Venta online',
        invoiceNo: '#0001',
        to: {
            name: 'Jonthan Cruz',
            email: 'hola@pro-tic.mx',
            address: 'Toltecas 166, Carola Alvaro Obregon, CDMX',
            phone: '55 3127 9167',
        },
        invoiceDate: '',
        dueDate: '',
        ...
        notes: 'Es un gusto poder servirle, ¡esperemos verlo pronto!',
    });
    useEffect(() => {
        ...
        <div className="flex xl:flex-row flex-col gap-2.5">
            <div className="panel px-0 flex-1 py-6 ltr:xl:mr-6 rtl:xl:ml-6">
                <div className="flex justify-between flex-wrap px-4">
                    <div className="mb-6 lg:w-1/2 w-full">
                        <div className="flex items-center text-black dark:text-white shrink-0">
                            <img src="/assets/images/logo/K-color.svg" alt="img" className="w-14" />
                        </div>
                    ...
                    <div className="lg:w-1/2 w-full lg:max-w-fit">
                        ...
                        <div className="flex items-center mt-4">
                            ...
                            <input id="invoiceLabel" type="text" name="inv-label" className="form-input lg:w-[250px] w-2/3" placeholder="Ingresa el asunto de factura"defaultValue={params.title}  />
                        </div>
                        <div className="flex items-center mt-4">
                            <label htmlFor="startDate" className="flex-1 ltr:mr-2 rtl:ml-2 mb-0">
                                Fecha de factura
                            </label>
                            <input id="startDate" type="date" name="inv-date" className="form-input lg:w-[250px] w-2/3" lang="es"defaultValue={params.invoiceDate} />
                        </div>
                        <div className="flex items-center mt-4">
                            <label htmlFor="dueDate" className="flex-1 ltr:mr-2 rtl:ml-2 mb-0">
                                Fecha de vencimiento
                            </label>
                            <input id="dueDate" type="date" name="due-date" className="form-input lg:w-[250px] w-2/3" lang="es"defaultValue={params.dueDate} />
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-8 px-4">
                    <div className="flex justify-between lg:flex-row flex-col">
                        <div className="lg:w-1/2 w-full ltr:lg:mr-6 rtl:lg:ml-6 mb-6">
                            <div className="text-lg">Facturar a:</div>
                            <div className="mt-4 flex items-center">
                                <label htmlFor="reciever-name" className="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">
                                    Nombre completo
                                </label>
                                <input id="reciever-name" type="text" name="reciever-name" className="form-input flex-1" defaultValue={params.to.name} placeholder="Ingresa el nombre completo" />
                            </div>
                            <div className="mt-4 flex items-center">
                                <label htmlFor="reciever-email" className="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">
                                    Correo electrónico
                                </label>
                                <input id="reciever-email" type="email" name="reciever-email" className="form-input flex-1" defaultValue={params.to.email} placeholder="Ingresa Correo electrónico" />
                            </div>
                            <div className="mt-4 flex items-center">
                                <label htmlFor="reciever-address" className="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">
                                    Dirección
                                </label>
                                <input id="reciever-address" type="text" name="reciever-address" className="form-input flex-1" defaultValue={params.to.address} placeholder="Ingresa Dirección" />
                            </div>
                            <div className="mt-4 flex items-center">
                                <label htmlFor="reciever-number" className="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">
                                    Número de teléfono
                                </label>
                                <input id="reciever-number" type="text" name="reciever-number" className="form-input flex-1" defaultValue={params.to.phone} placeholder="Ingresa Número de teléfono" />
                            </div>
                        </div>
                        <div className="lg:w-1/2 w-full">
                            <div className="text-lg">Datos de pago:</div>
                            <div className="flex items-center mt-4">
                                <label htmlFor="acno" className="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">
                                    Número de cuenta
                                </label>
                                <input id="acno" type="text" name="acno" className="form-input flex-1" defaultValue={params.bankInfo.no} placeholder="Ingresa Número de cuenta" />
                            </div>
                            <div className="flex items-center mt-4">
                                <label htmlFor="bank-name" className="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">
                                    Nombre del banco
                                </label>
                                <input id="bank-name" type="text" name="bank-name" className="form-input flex-1" defaultValue={params.bankInfo.name}placeholder="Ingresa Nombre del banco" />
                            </div>
                            <div className="flex items-center mt-4">
                                <label htmlFor="swift-code" className="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">
                                    Número SWIFT
                                </label>
                                <input id="swift-code" type="text" name="swift-code" className="form-input flex-1" defaultValue={params.bankInfo.swiftCode} placeholder="Ingresa Número SWIFT" />
                            </div>
                            <div className="flex items-center mt-4">
                                <label htmlFor="iban-code" className="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">
                                    Número IBAN
                                </label>
                                <input id="iban-code" type="text" name="iban-code" className="form-input flex-1" defaultValue={params.bankInfo.ibanNo} placeholder="Ingresa Número IBAN" />
                            </div>
                            <div className="flex items-center mt-4">
                                ...
                                {items.map((item: any, index: any) => {
                                    return (
                                        <tr className="align-top" key={item.id}>
                                            <td>
                                                <input type="text" className="form-input min-w-[200px]" placeholder="Ingresa el nombre del producto"  defaultValue={item.title} />
                                                <textarea className="form-textarea mt-4" placeholder="Ingresa la descripción"  defaultValue={item.description}></textarea>
                                            </td>
                                            <td>
                                                <input
                                                    type="number"
                ...
                <div className="mt-8 px-4">
                    ...
                    <textarea id="notes" name="notes" className="form-textarea min-h-[130px]" placeholder="Notas...." defaultValue={params.notes}></textarea>
                </div>
            </div>
                    ...
                    <div className="mt-4">
                        <div className="grid sm:grid-cols-2 grid-cols-1 gap-4">
                            <div>
                                ...
                                <input id="tax" type="number" name="tax" className="form-input" placeholder="Impuestos" value={tax} onChange={(e) => setTax(e.target.value)} />
                            </div>
                            <div>
                                <label htmlFor="discount">Descuento(%) </label>
                                <input id="discount" type="number" name="discount" className="form-input" placeholder="Descuento" value={discount} onChange={(e) => setDiscount(e.target.value)} />
                            </div>
                        </div>
                    </div>
                    <div className="mt-4">
                        <label htmlFor="shipping-charge">Cargos de envíos($) </label>
                        <input
                            id="shipping-charge"
                            type="number"
                            name="shipping-charge"
                            className="form-input"
                            placeholder="Cargos de envíos"
                            value={shippingCharge}
                            onChange={(e) => setShippingCharge(e.target.value)}
                        />
                    </div>
                    <div className="mt-4">
                        <label htmlFor="payment-method">Aceptar pago mediante</label>
