    ...
    const [messages, setMessages] = useState([
        {
            ...
            title: 'Exitosamente',
            message: 'Tu sistema se ha actualizado',
            time: '1hr',
        },
        {
            id: 2,
            ...
            title: '¿Lo sabías?',
            message: 'Puedes tener mas de un grupo',
            time: '2hr',
        },
        {
            id: 3,
    ...
    const [notifications, setNotifications] = useState([
        {
            ...
            message: '<strong className="text-sm mr-1">John Doe</strong> te invito a unirse a <strong>Fútbol</strong>',
            time: '45 min atrás',
        },
        {
            id: 2,
            profile: 'profile-34.jpeg',
            message: '<strong className="text-sm mr-1">Adam Nolan</strong> te menciono en <strong> Baloncesto</strong>',
            time: '9h atrás',
        },
        {
            id: 3,
            profile: 'profile-16.jpeg',
            message: '<strong className="text-sm mr-1">Anna Morgan</strong> Actualizo su foto',
            time: '9h atrás',
        },
    ]);
            ...
            <div className="shadow-sm">
                <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                        <Link to="/entrenador" className="main-logo flex items-center shrink-0">
                            <img className="w-10 ltr:-ml-1 rtl:-mr-1 inline" src="/assets/images/logo/K-color.svg" alt="logo" />
                            <span className="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle hidden md:inline dark:text-white-light transition-all duration-300">KOBU</span>
                        </Link>
                        <button
                            type="button"
                    ...
                    <div className="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center space-x-1.5 lg:space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
                        <div className="sm:ltr:mr-auto sm:rtl:ml-auto w-1/3">
                            <form
                            ...
                            >
                                <div className="relative">
                                    <input
                                        type="text"
                                        className="form-input w-[100%] ltr:pl-9 rtl:pr-9 ltr:sm:pr-4 rtl:sm:pl-4 ltr:pr-9 rtl:pl-9 peer sm:bg-transparent bg-gray-100 placeholder:tracking-widest"
                                        placeholder="Buscar..."
                                    />
                                        ...
                                        <>
                                            ...
                                            <li className="border-t border-white-light text-center dark:border-white/10 mt-5">
                                                <button type="button" className="text-primary font-semibold group dark:text-gray-400 justify-center !py-4 !h-[48px]">
                                                    <span className="group-hover:underline ltr:mr-1 rtl:ml-1">VER TODAS LAS ACTIVIDADES</span>
                                ...
                                <ul className="!py-0 text-dark dark:text-white-dark w-[300px] sm:w-[350px] divide-y dark:divide-white/10">
                                    <li onClick={(e) => e.stopPropagation()}>
                                        <div className="flex items-center px-4 py-2 justify-between font-semibold">
                                            ...
                                            {notifications.length ? <span className="badge bg-primary/80">{notifications.length} Nuevas</span> : ''}
                                        </div>
                                    </li>
                                    {notifications.length > 0 ? (
                                        <>
                                            ...
                                            <li>
                                                <div className="p-4">
                                                    <button className="btn btn-primary block w-full btn-small">Leer todas las notificaciones</button>
                                                </div>
                                            </li>
                                        </>
                                    ) : (
                        ...
                        <div className="dropdown shrink-0 flex">
                            ...
                            >
                                <ul className="text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90">
                                    ...
                                    <li>
                                        <Link to="/entrenador/perfil" className="dark:hover:text-white">
                                            <IconUser className="w-4.5 h-4.5 ltr:mr-2 rtl:ml-2 shrink-0" />
                                            Perfil
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="/entrenador/mensajes" className="dark:hover:text-white">
